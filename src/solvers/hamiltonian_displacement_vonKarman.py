...
from utils.utils_von_karman import mass_form_energy, operator_energy, functional_energy
import numpy as np
...
class HamiltonianVonKarmanSolver:
    def __init__(self,
        ...
        bend_displacement_exp = expr_t0["bend displacement"]

        mem_velocity_exp = expr_t0["mem velocity"]
        bend_velocity_exp = expr_t0["bend velocity"]
        ...
        bend_stress_bcs = [fdrk.DirichletBC(space_energy.sub(1), item[1], item[0]) \
